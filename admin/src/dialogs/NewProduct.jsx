  ...
  return (
    <div>
      <button
        ...
        className="flex bg-green-600 cursor-pointer p-1 text-xs px-2 rounded text-white font-semibold"
      >
       <Plus className="w-4 h-4"/> New Product
      </button>

      <Dialog addProduct={addProduct} categories={categories} open={open} onClose={() => setOpen(false)} />
    </div>
  );
};
          ...
          <div className="flex flex-col gap-2">
            ...
            <div>
              <button
                ...
                className="mt-5 bg-green-600 cursor-pointer p-1 text-xs px-2 rounded text-white font-semibold"
              >
